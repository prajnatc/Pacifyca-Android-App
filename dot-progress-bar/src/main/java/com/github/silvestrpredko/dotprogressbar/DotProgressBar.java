...
public class DotProgressBar extends View {
    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                setStartColor(
                        a.getInteger(
                                ...
                                getContext().getResources().getColor(R.color.light_blue_A700)
                        )
                );
                setEndColor(
                        a.getInteger(
                                R.styleable.DotProgressBar_endColor,
                                getContext().getResources().getColor(R.color.light_blue_A400)
                        )
                );
            ...
            setStartColor(getContext().getResources().getColor(R.color.light_blue_A700));
            setEndColor(getContext().getResources().getColor(R.color.light_blue_A400));
